...
df = pd.read_csv('Prompted-Assertion-Generation-dataset.csv')
...
with open('Prompted-Assertion-Generation-Prompts.csv', 'w', newline='') as csv_file:
    ...
    for id in range(len(df)):
        ...
        prompt = f"Given Verilog code snippet as below: \n{purecode}\n Please generate a rewritten version of it, which contains several useful assertions and each of them follows a description as follows:\n{humanexplanation}\n"
